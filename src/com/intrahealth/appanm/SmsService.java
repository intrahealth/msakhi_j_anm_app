...
public class SmsService extends Service {
    ...
    public static final String BROADCAST_ACTION = "com.intrahealth.appanm.smsservice";
	...
	private Runnable periodicTask = new Runnable() {
		public void run() {	
		 link=AppVariables.API(c);
			...
			Log.i("msakhi",radio_on+"");
			if (radio_on)
			{
			Log.d("SmsService", "SmsServices is working");
			...
			if (pendSms.moveToFirst())
				...
				switch (rt) {
				case 0: 
					Log.d("entered ","in post");								
//					DefaultHttpClient httpClient = new DefaultHttpClient();
//		            HttpEntity httpEntity = null;
//		            HttpResponse httpResponse = null;
//		            HttpPost httpPost = new HttpPost("http://192.168.1.29/msakhi/resturl/index.php"+url);
//		            httpResponse = httpClient.execute(httpPost);
		            //webb.post(DBAdapter.resturl+url).body(payload).ensureSuccess().asJsonObject();
					Response<String> response = webb							
					        .post( link+"resturl/index.php"+url)
					        .body(payload)
					        .connectTimeout(10 * 1000)
					        .asString();
                    Log.d("claerrrrrr",link+"resturl/index.php"+url);
					if (response.isSuccess()) {
					    String outcome = response.getBody();
                      Log.d("response",outcome);
					    // ...
					...
					break;
				case 1:
					Log.d("entered ","in put");
//					DefaultHttpClient httpClient1 = new DefaultHttpClient();
//		            HttpEntity httpEntity1 = null;
//		            HttpResponse httpResponse1 = null;
//		            HttpPost httpPost1 = new HttpPost("http://192.168.1.29/msakhi/resturl/index.php"+url);
//		            httpResponse1 = httpClient1.execute(httpPost1);
					//webb.put(DBAdapter.resturl+url).body(payload).ensureSuccess().asJsonObject();				
					JSONArray arr=new JSONArray();
					JSONObject newpayload;				
					newpayload = new JSONObject(msg);
					JSONObject obj=new JSONObject();
					obj.put("key",msgid);
					obj.put("data",msg);
					//newpayload.put("key",msg);		
					//arr.put(newpayload);
					arr.put(obj);
					Log.d("entered ",obj+"");
					Response<String> response1 = webb
					       // .post("http://192.168.1.29/msakhi/resturl/index.php"+url)
							.post(link+"resturl/index.php/"+url)
						//	.post(link+"save.php"+url)
					        .body(arr)
					        .connectTimeout(10 * 1000)
					        .asString();
					Log.d("clearrrrrr",link+"resturl/index.php/"+url);
					if (response1.isSuccess()) {
					    String outcome = response1.getBody();
					   Log.d("responseeeeeeeee",outcome);
					    ...
					    System.out.println(response1.getErrorBody());
					} 
					break;
				default:
					break;
			  ...
			  mydb.deleteWeb(msgid);
			  	Log.d("SmsService", msg+" "+String.valueOf(msgid));
				} catch (Exception e) {
			...
			if (serviceRunning) 
				{
				Log.i("masakhi","inside_servicerunning");
