...
public class LazyCursorAdapterdue extends SimpleCursorAdapter  {
	...
	public LazyCursorAdapterdue(Context context, int layout, Cursor c,
			String[] from, int[] to) {
    ...
    public View newView(Context context, Cursor cursor, ViewGroup parent) {
        ...
        tvCnt.setVisibility(android.view.View.GONE);
