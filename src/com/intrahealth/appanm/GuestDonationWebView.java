...
public class GuestDonationWebView extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// });
		//
		gLobal = (GoogleAnalyticsApp) getApplication();
	...
	public void onBackPressed() {
		...
		if (gLobal.getGlobalWebViewBypass() == 1) {
			Intent in = new Intent(GuestDonationWebView.this,
					MainActivity.class);
			finish();
			startActivity(in);
	...
	private String getPostString() {
		...
		post.append("user=");
		post.append(gLobal.getGlobaluserid());
		post.append("&");
		post.append("pass=");
		post.append(gLobal.getGlobalpassword());
		...
		try {
			...
			checkSumStr.append(gLobal.getGlobaluserid());
			checkSumStr.append("|");
			checkSumStr.append(gLobal.getGlobalpassword());
			checkSumStr.append("|");
